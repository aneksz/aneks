...
# -----------------------------
fastfetch -c ~/.local/share/fastfetch/graphite.jsonc --logo /home/igor/Downloads/images/anime-girl.png --logo-type kitty --logo-width 20 --logo-height 8
...
if command -v exa >/dev/null 2>&1; then
    alias ls="exa -lh $EZA_FLAGS --group-directories-first"
    alias ll="exa -l $EZA_FLAGS --group-directories-first"
else
...
[ -f ~/.config/.theme_terminal ] && source ~/.config/.theme_terminal
