...
awww img ~/.config/themes/dracula/wallpapers/dracula1.png --outputs DP-1 --transition-type any
awww img ~/.config/themes/dracula/wallpapers/dracula2.png --outputs DP-3 --transition-type any
