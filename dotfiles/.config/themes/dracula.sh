...
awww img ~/.config/themes/dracula/wallpapers/dracula1.png --outputs DP-1 --transition-type grow
awww img ~/.config/themes/dracula/wallpapers/dracula2.png --outputs DP-3 --transition-type grow
...
# Hyprlock
# ------------------------
ln -sf "$HYPR_DIR/background/dracula1.png" "$HYPR_DIR/background/current.png"
