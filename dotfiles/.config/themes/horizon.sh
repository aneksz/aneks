...
awww img ~/.config/themes/horizon/wallpapers/horizon.png --outputs DP-1 --transition-type any
awww img ~/.config/themes/horizon/wallpapers/horizon3.png --outputs DP-3 --transition-type any
