...
awww img ~/.config/themes/rose-pine/wallpapers/rose3.png --outputs DP-1 --transition-type grow
awww img ~/.config/themes/rose-pine/wallpapers/rose4.png --outputs DP-3 --transition-type grow
...
# Hyprlock
# ------------------------
ln -sf "$HYPR_DIR/background/rose3.png" "$HYPR_DIR/background/current.png"
