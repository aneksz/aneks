...
awww img ~/.config/themes/rose-pine/wallpapers/rose3.png --outputs DP-1 --transition-type any
awww img ~/.config/themes/rose-pine/wallpapers/rose4.png --outputs DP-3 --transition-type any
