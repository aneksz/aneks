...
awww img ~/.config/themes/tokyo-night/wallpapers/tokyo2.png --outputs DP-1 --transition-type grow
awww img ~/.config/themes/tokyo-night/wallpapers/tokyo1.jpg --outputs DP-3 --transition-type grow
